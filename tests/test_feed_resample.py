...
if __name__ == '__main__':
    ...
    data1 = cerebro.resampledata(timeframe=bt.TimeFrame.Days, compression=1)

    # data2 = cerebro.resampledata(timeframe=bt.TimeFrame.Weeks, compression=1)

    # data3 = cerebro.resampledata(timeframe=bt.TimeFrame.Months, compression=1)

    # data4 = cerebro.resampledata(timeframe=bt.TimeFrame.Years, compression=1)
