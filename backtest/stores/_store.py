...
class PseudoStore(with_metaclass(MetaSingleton, object)):
    ...
    def get_instrument(self, dataname):
        try:
            insts = self.oapi.get_instruments(self.p.cliend_id,
    ...
    def _t_get_history(self, dataname, dtbegin, dtend, timeframe, compression,
    ...
    def get_positions(self):
        try:
            positions = self.oapi.get_positions(self.p.client_id)
        except (oandapy.OandaError, OandaRequestError,):
            return None
