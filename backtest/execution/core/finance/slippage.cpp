...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "backtest.execution.core.finance.slippage",
        "sources": [
            "backtest/execution/core/finance/slippage.pyx"
        ]
    },
    "module_name": "backtest.execution.core.finance.slippage"
}
END: Cython Metadata */
...
#define __PYX_HAVE__backtest__execution__core__finance__slippage
#define __PYX_HAVE_API__backtest__execution__core__finance__slippage
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
struct __pyx_vtabstruct_8backtest_9execution_4core_7finance_8slippage_Slippage {
  double (*_slip_up)(struct __pyx_obj_8backtest_9execution_4core_7finance_8slippage_Slippage *, double, double);
...
extern int __pyx_module_is_main_backtest__execution__core__finance__slippage;
int __pyx_module_is_main_backtest__execution__core__finance__slippage = 0;
...
static PyObject *__pyx_pw_8backtest_9execution_4core_7finance_8slippage_8Slippage_1__call__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_AddTraceback("backtest.execution.core.finance.slippage.Slippage.__call__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_AddTraceback("backtest.execution.core.finance.slippage.Slippage.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
...
*/
  ...
  __pyx_t_2 = __pyx_f_8backtest_9execution_4core_7finance_8slippage___pyx_unpickle_Slippage__set_state(__pyx_v_self, ((PyObject*)__pyx_t_1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
...
/* Python wrapper */
static PyObject *__pyx_pw_8backtest_9execution_4core_7finance_8slippage_1__pyx_unpickle_Slippage(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_8backtest_9execution_4core_7finance_8slippage_1__pyx_unpickle_Slippage = {"__pyx_unpickle_Slippage", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_8backtest_9execution_4core_7finance_8slippage_1__pyx_unpickle_Slippage, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8backtest_9execution_4core_7finance_8slippage_1__pyx_unpickle_Slippage(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_AddTraceback("backtest.execution.core.finance.slippage.__pyx_unpickle_Slippage", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v___pyx_state), (&PyTuple_Type), 1, "__pyx_state", 1))) __PYX_ERR(1, 4, __pyx_L1_error)
  __pyx_r = __pyx_pf_8backtest_9execution_4core_7finance_8slippage___pyx_unpickle_Slippage(__pyx_self, __pyx_v___pyx_type, __pyx_v___pyx_checksum, __pyx_v___pyx_state);
...
static PyObject *__pyx_pf_8backtest_9execution_4core_7finance_8slippage___pyx_unpickle_Slippage(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v___pyx_type, long __pyx_v___pyx_checksum, PyObject *__pyx_v___pyx_state) {
...
*/
  __pyx_t_3 = ((PyObject *)__pyx_mstate_global->__pyx_ptype_8backtest_9execution_4core_7finance_8slippage_Slippage);
...
*/
    ...
    __pyx_t_2 = __pyx_f_8backtest_9execution_4core_7finance_8slippage___pyx_unpickle_Slippage__set_state(((struct __pyx_obj_8backtest_9execution_4core_7finance_8slippage_Slippage *)__pyx_v___pyx_result), __pyx_v___pyx_state); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 9, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static struct __pyx_vtabstruct_8backtest_9execution_4core_7finance_8slippage_Slippage __pyx_vtable_8backtest_9execution_4core_7finance_8slippage_Slippage;

static PyObject *__pyx_tp_new_8backtest_9execution_4core_7finance_8slippage_Slippage(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_8backtest_9execution_4core_7finance_8slippage_Slippage *p;
  PyObject *o;
  o = __Pyx_AllocateExtensionType(t, 0);
  if (unlikely(!o)) return 0;
  p = ((struct __pyx_obj_8backtest_9execution_4core_7finance_8slippage_Slippage *)o);
  p->__pyx_vtab = __pyx_vtabptr_8backtest_9execution_4core_7finance_8slippage_Slippage;
  return o;
}

static void __pyx_tp_dealloc_8backtest_9execution_4core_7finance_8slippage_Slippage(PyObject *o) {
  #if CYTHON_USE_TP_FINALIZE
  if (unlikely(__Pyx_PyObject_GetSlot(o, tp_finalize, destructor)) && (!PyType_IS_GC(Py_TYPE(o)) || !__Pyx_PyObject_GC_IsFinalized(o))) {
    if (__Pyx_PyObject_GetSlot(o, tp_dealloc, destructor) == __pyx_tp_dealloc_8backtest_9execution_4core_7finance_8slippage_Slippage) {
...
static PyType_Spec __pyx_type_8backtest_9execution_4core_7finance_8slippage_Slippage_spec = {
  "backtest.execution.core.finance.slippage.Slippage",
  sizeof(struct __pyx_obj_8backtest_9execution_4core_7finance_8slippage_Slippage),
  0,
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_VERSION_TAG|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE,
  __pyx_type_8backtest_9execution_4core_7finance_8slippage_Slippage_slots,
};
#else

static PyTypeObject __pyx_type_8backtest_9execution_4core_7finance_8slippage_Slippage = {
  PyVarObject_HEAD_INIT(0, 0)
  "backtest.execution.core.finance.slippage.""Slippage", /*tp_name*/
  sizeof(struct __pyx_obj_8backtest_9execution_4core_7finance_8slippage_Slippage), /*tp_basicsize*/
  0, /*tp_itemsize*/
  ...
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_8backtest_9execution_4core_7finance_8slippage_Slippage, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
...
static int __Pyx_modinit_type_init_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Type init code ---*/
  __pyx_vtabptr_8backtest_9execution_4core_7finance_8slippage_Slippage = &__pyx_vtable_8backtest_9execution_4core_7finance_8slippage_Slippage;
  ...
  #endif
  #if !CYTHON_COMPILING_IN_LIMITED_API
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_mstate->__pyx_ptype_8backtest_9execution_4core_7finance_8slippage_Slippage->tp_dictoffset && __pyx_mstate->__pyx_ptype_8backtest_9execution_4core_7finance_8slippage_Slippage->tp_getattro == PyObject_GenericGetAttr)) {
...
__Pyx_RefNannySetupContext("PyInit_slippage", 0);
  ...
  if (__pyx_module_is_main_backtest__execution__core__finance__slippage) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "backtest.execution.core.finance.slippage")) {
      if (unlikely((PyDict_SetItemString(modules, "backtest.execution.core.finance.slippage", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  #endif
  if (__Pyx_SetItemOnTypeDict(__pyx_mstate_global->__pyx_ptype_8backtest_9execution_4core_7finance_8slippage_Slippage, __pyx_mstate_global->__pyx_n_u_reduce_cython, __pyx_t_2) < (0)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init backtest.execution.core.finance.slippage", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init backtest.execution.core.finance.slippage");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
